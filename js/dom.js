...
//Actividad
let articleTexto = document.createElement("article");
let texto = document.createTextNode("Mi Foto");
articleTexto.appendChild(texto);
document.getElementById("nuevo").appendChild(articleTexto);

let articleImagen = document.createElement("article");
let image = document.createElement("img");
image.setAttribute('src', './imagen/m.png');  
articleImagen.appendChild(image);
document.getElementById("nuevo").appendChild(articleImagen);

let articleTextoDuplicado = articleTexto.cloneNode(true);
document.getElementById("nuevo").appendChild(articleTextoDuplicado);

let articleImagenDuplicado = articleImagen.cloneNode(true);
document.getElementById("nuevo").appendChild(articleImagenDuplicado);
